...
var pureJSCalendar = (function () {
    ...
    function open(dateFormat, x, y, firstDayOfWeek, minDate, maxDate, element, zindex) {
        ...
        const newHtml = '<div id="cal" style="top:' + y + 'px;left:' + x + 'px;z-index:' + zindex + ';">' +
            ...
            '<table id="days">' +
                '<tr>' +
                    '<td id="eformSun">sun</td>' +
                    '<td id="eformMon">mon</td>' +
                    '<td id="eformTue">tue</td>' +
                    '<td id="eformWed">wed</td>' +
                    '<td id="eformThu">thu</td>' +
                    '<td id="eformFri">fri</td>' +
                    '<td id="eformSat">sat</td>' +
                '</tr>' +
            '</table>' +
            '<div id="cal-frame">' +
                '<table class="curr">' +
            ...
            '</div>' +
            '<div id="time">' +
                '<input type="number" min="00" max="23" step="1" />' +
                '<input type="number" min="00" max="59" step="1" />' +
            '</div>' +
        '</div>';
